    ...
    def twenty_percent_tax_calculation(self):
        ...
        for item in twenty_percent_tax:
            if item in self.__item_price:
                total.append(self.__item_price[item])
        nds_20 = 0
        for to in twenty_percent_tax:
            nds_20 += self.__item_price[to] * 0.2
        return nds_20
    ...
    def ten_percent_tax_calculation(self):
        ...
        for item in ten_percent_tax:
            if item in self.__item_price:
                total.append(self.__item_price[item])
        nds_10 = 0
        for to in ten_percent_tax:
            nds_10 += self.__item_price[to] * 0.1
        return nds_10
...
online.check_amount()
online.twenty_percent_tax_calculation()
online.ten_percent_tax_calculation()
online.total_tax()
online.get_telephone_number(9466664564)
